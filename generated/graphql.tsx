...
export type IncrementViewMutation = (
  { __typename?: 'Mutation' }
  & { updatePost?: Maybe<(
    { __typename?: 'updatePostPayload' }
    & { post?: Maybe<(
 ...
 * });
 */
export function useIncrementViewMutation(baseOptions?: Apollo.MutationHookOptions<IncrementViewMutation, IncrementViewMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<IncrementViewMutation, IncrementViewMutationVariables>(IncrementViewDocument, options);
      }
